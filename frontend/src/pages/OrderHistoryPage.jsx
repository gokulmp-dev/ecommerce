            ...
            >
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="text-right">
                  ...
                  <p className="text-yellow-500 font-bold">${order.totalPrice.toFixed(2)}</p>
                </div>
                <div className="text-right">
              ...
              <button
                ...
                className="bg-gray-900 text-white px-4 py-2 rounded-lg text-sm hover:bg-yellow-500 transition"
              >
                View Details
              </button>
            </div>
